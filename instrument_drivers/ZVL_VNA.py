...
# This is a beta version of ZVL VNA driver
...
#     def __init__(self, name, start, stop, npts, instrument='ZVL_VNA',*args, **kwargs):
...
class ZVL_VNA(VisaInstrument):
    """
    This is the QCoDeS python driver for Rohde and Schwartz ZVL_VNA.
    ...
    def __init__(self, name       : str,
                       ...
                       **kwargs):
        """
        QCoDeS driver for the signal analyzer R&S ZVL VNA.
        Args:
        ...
        self.add_parameter(name       = 'sweep_points',
                           ...
                           vals = vals.Ints(min_value = 2, max_value = 12001)
                           )
        ...
        self.add_parameter(name       = 'external_reference',
                           unit       = None,
                           set_cmd    = 'SOUR:EXT:ROSC {};*WAI',
                           get_cmd    = 'SOUR:EXT:ROSC?;*WAI',
                           vals = vals.Bool(),
