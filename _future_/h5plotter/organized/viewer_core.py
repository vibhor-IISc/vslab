# hdf_viewer/viewer_core.py  -- SLOW response
...
#             self.row_line, = self.cross_section_axes[0].plot(data[y, :], label="Row")
#             self.col_line, = self.cross_section_axes[1].plot(data[:, x], label="Column")
#             self.cross_section_axes[0].set_ylabel("Value")
#             self.cross_section_axes[1].set_ylabel("Value")
#             self.cross_section_axes[0].legend()
#             self.cross_section_axes[1].legend()
...
#         else:
#             self.row_line.set_ydata(data[y, :])
#             self.col_line.set_ydata(data[:, x])
#             self.cross_section_axes[0].relim()
#             self.cross_section_axes[0].autoscale_view()
#             self.cross_section_axes[1].relim()
#             self.cross_section_axes[1].autoscale_view()
#             self.cross_section_figure.suptitle(f"Cross-sections at (x={x}, y={y})")
